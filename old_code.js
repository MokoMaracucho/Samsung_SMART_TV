...
loader.load(
	...
	function (gltf) {
        ...
        // -> AJOUTER AMBIENT OCCLUSION
        // -> AJOUTER GLOSSINESS

                //let Key_power_FOLDER = gui.addFolder('Key_power');
                ...
                /* Key_power_FOLDER.addColor(colors, 'Key_power_COLOR')
                    .name('color')
                    .onChange(function() {
                        Key_power_MATERIAL.color.set(colors.Key_power_COLOR);
                    });
                Key_power_FOLDER.add(Key_power_MATERIAL, 'metalness').min(0).max(1).step(0.0001);
                Key_power_FOLDER.add(Key_power_MATERIAL, 'roughness').min(0).max(1).step(0.0001); */

                Key_power_MESH.material = Key_power_MATERIAL;

        // 2 = Panel_front_1

                /* let Panel_front_1_FOLDER = gui.addFolder('Panel_front_1'); */
                ...
                /* Panel_front_1_FOLDER.addColor(colors, 'Panel_front_1_COLOR')
                    .name('color')
                    .onChange(function() {
                        Panel_front_1_MATERIAL.color.set(colors.Panel_front_1_COLOR);
                    });
                Panel_front_1_FOLDER.add(Panel_front_1_MATERIAL, 'metalness').min(0).max(1).step(0.0001);
                Panel_front_1_FOLDER.add(Panel_front_1_MATERIAL, 'roughness').min(0).max(1).step(0.0001); */

                Panel_front_1_MESH.material = Panel_front_1_MATERIAL;

        // 3 = Panel_front_2

                /* let Panel_front_2_FOLDER = gui.addFolder('Panel_front_2'); */
                ...
                /* Panel_front_2_FOLDER.addColor(colors, 'Panel_front_2_COLOR')
                    .name('color')
                    .onChange(function() {
                        Panel_front_2_MATERIAL.color.set(colors.Panel_front_2_COLOR);
                    });
                Panel_front_2_FOLDER.add(Panel_front_2_MATERIAL, 'metalness').min(0).max(1).step(0.0001);
                Panel_front_2_FOLDER.add(Panel_front_2_MATERIAL, 'roughness').min(0).max(1).step(0.0001); */
        ...
        // 5 = Phone_opas
                ...
                /* let Phone_opas_FOLDER = gui.addFolder('Phone_opas'); */
                ...
                /* Phone_opas_MATERIAL.color = new THREE.Color( 0x808080 );
                Phone_opas_MATERIAL.metalness = 0.8;
                Phone_opas_MATERIAL.roughness = 0.2; */
                /* Phone_opas_MATERIAL.aoMap = Phone_opas_AO_TEXTURE; */
        ...
        // 6 = Plastik_glanek
            ...
            /* let Plastik_glanek_FOLDER = gui.addFolder('Plastik_glanek'); */
            ...
            /* Plastik_glanek_FOLDER.addColor(colors, 'Plastik_glanek_COLOR')
                .name('color')
                .onChange(function() {
                    Plastik_glanek_MATERIAL.color.set(colors.Plastik_glanek_COLOR);
                });
            Plastik_glanek_FOLDER.add(Plastik_glanek_MATERIAL, 'metalness').min(0).max(1).step(0.0001);
            Plastik_glanek_FOLDER.add(Plastik_glanek_MATERIAL, 'roughness').min(0).max(1).step(0.0001); */

            Plastik_glanek_MESH.material = Plastik_glanek_MATERIAL;

        // 7 = Panel_back

            /* let Panel_back_FOLDER = gui.addFolder('Panel_back'); */
        ...
        // 8 = Chrom_kant
            ...
            /* let Chrom_kant_FOLDER = gui.addFolder('Chrom_kant'); */
            ...
            /* Chrom_kant_FOLDER.addColor(colors, 'Chrom_kant_COLOR')
                .name('color')
                .onChange(function() {
                    Chrom_kant_MATERIAL.color.set(colors.Chrom_kant_COLOR);
                });
            Chrom_kant_FOLDER.add(Chrom_kant_MATERIAL, 'metalness').min(0).max(1).step(0.0001);
            Chrom_kant_FOLDER.add(Chrom_kant_MATERIAL, 'roughness').min(0).max(1).step(0.0001); */
        ...
        // 10 = Chrom_rem
            ...
            /* let Chrom_rem_FOLDER = gui.addFolder('Chrom_rem'); */
            ...
            /* Chrom_rem_FOLDER.addColor(colors, 'Chrom_rem_COLOR')
                .name('color')
                .onChange(function() {
                    Chrom_rem_MATERIAL.color.set(colors.Chrom_rem_COLOR);
                });
            Chrom_rem_FOLDER.add(Chrom_rem_MATERIAL, 'metalness').min(0).max(1).step(0.0001);
            Chrom_rem_FOLDER.add(Chrom_rem_MATERIAL, 'roughness').min(0).max(1).step(0.0001); */

            Chrom_rem_MESH.material = Chrom_rem_MATERIAL;

        // 11 = Back_label

            /* let Back_label_FOLDER = gui.addFolder('Back_label'); */
            ...
            /* Back_label_FOLDER.addColor(colors, 'Back_label_COLOR')
                .name('color')
                .onChange(function() {
                    Chrom_rem_MATERIAL.color.set(colors.Back_label_COLOR);
                });
            Back_label_FOLDER.add(Back_label_MATERIAL, 'metalness').min(0).max(1).step(0.0001);
            Back_label_FOLDER.add(Back_label_MATERIAL, 'roughness').min(0).max(1).step(0.0001); */

            Back_label_MESH.material = Back_label_MATERIAL;

        // 12 = Screen_off

            /* let Screen_off_FOLDER = gui.addFolder('Screen_off'); */
            ...
            /* Screen_off_FOLDER.addColor(colors, 'Screen_off_COLOR')
                .name('color')
                .onChange(function() {
                    Screen_off_MATERIAL.color.set(colors.Screen_off_COLOR);
                });
            Screen_off_FOLDER.add(Screen_off_MATERIAL, 'metalness').min(0).max(1).step(0.0001);
            Screen_off_FOLDER.add(Screen_off_MATERIAL, 'roughness').min(0).max(1).step(0.0001); */

            Screen_off_MESH.material = Screen_off_MATERIAL;

        // 13 = Chrom

            /* let Chrom_FOLDER = gui.addFolder('Chrom'); */
            ...
            /* Chrom_MATERIAL.aoMap = Chrom_AO_TEXTURE;
            Chrom_MATERIAL.aoMapIntensity = 1; */
            Chrom_MATERIAL.envMap = environnementMapTexture;

            /* Chrom_FOLDER.addColor(colors, 'Chrom_COLOR')
                .name('color')
                .onChange(function() {
                    Chrom_MATERIAL.color.set(colors.Chrom_COLOR);
                });
            Chrom_FOLDER.add(Chrom_MATERIAL, 'metalness').min(0).max(1).step(0.0001);
            Chrom_FOLDER.add(Chrom_MATERIAL, 'roughness').min(0).max(1).step(0.0001);
            Chrom_FOLDER.open(); */
        ...
        // 14 = Metall_strip
            ...
            /* let Metall_strip_FOLDER = gui.addFolder('Metall_strip'); */

            var Metall_strip_MESH = gltf.scene.getObjectByName("Samsung_SMART_TV_14");
            /* Metall_strip_MESH.geometry.setAttribute('uv2', new THREE.BufferAttribute(Metall_strip_MESH.geometry.attributes.uv.array, 2)); */
            ...
            /* Metall_strip_MATERIAL.color = new THREE.Color( 0xFFFFFF ); */
            /* Metall_strip_MATERIAL.metalness = 0.6;
            Metall_strip_MATERIAL.roughness = 0; */
            /* Metall_strip_MATERIAL.aoMap = Chrom_AO_TEXTURE;
            Metall_strip_MATERIAL.aoMapIntensity = 1; */
            Metall_strip_MATERIAL.envMap = environnementMapTexture;

            /* Metall_strip_FOLDER.addColor(colors, 'Metall_strip_COLOR')
                .name('color')
                .onChange(function() {
                    Metall_strip_MATERIAL.color.set(colors.Metall_strip_COLOR);
                });
            Metall_strip_FOLDER.add(Metall_strip_MATERIAL, 'metalness').min(0).max(1).step(0.0001);
            Metall_strip_FOLDER.add(Metall_strip_MATERIAL, 'roughness').min(0).max(1).step(0.0001);
            Metall_strip_FOLDER.open(); */

            Metall_strip_MESH.material = Metall_strip_MATERIAL;

        // 15 = Glass_black

            /* let Glass_black_FOLDER = gui.addFolder('Glass_black'); */

            var Glass_black_MESH = gltf.scene.getObjectByName("Samsung_SMART_TV_15");
            /* Glass_black_MESH.geometry.setAttribute('uv2', new THREE.BufferAttribute(Glass_black_MESH.geometry.attributes.uv.array, 2)); */
            ...
            /* Glass_black_FOLDER.addColor(colors, 'Glass_black_COLOR')
                .name('color')
                .onChange(function() {
                    Glass_black_MATERIAL.color.set(colors.Glass_black_COLOR);
                });
            Glass_black_FOLDER.add(Glass_black_MATERIAL, 'metalness').min(0).max(1).step(0.0001);
            Glass_black_FOLDER.add(Glass_black_MATERIAL, 'roughness').min(0).max(1).step(0.0001);
            Glass_black_FOLDER.open(); */

            Glass_black_MESH.material = Glass_black_MATERIAL;

        // 16 = Metall_dark

            /* let Metall_dark_FOLDER = gui.addFolder('Metall_dark'); */
            ...
            /* Metall_dark_FOLDER.addColor(colors, 'Metall_dark_COLOR')
                .name('color')
                .onChange(function() {
                    Metall_dark_MATERIAL.color.set(colors.Metall_dark_COLOR);
                });
            Metall_dark_FOLDER.add(Metall_dark_MATERIAL, 'metalness').min(0).max(1).step(0.0001);
            Metall_dark_FOLDER.add(Metall_dark_MATERIAL, 'roughness').min(0).max(1).step(0.0001); */

            Metall_dark_MESH.material = Metall_dark_MATERIAL;

        // 17 = Gold

            /* let Gold_FOLDER = gui.addFolder('Gold'); */
            ...
            /* Gold_FOLDER.addColor(colors, 'Gold_COLOR')
                .name('color')
                .onChange(function() {
                    Gold_MATERIAL.color.set(colors.Gold_COLOR);
                });
            Gold_FOLDER.add(Gold_MATERIAL, 'metalness').min(0).max(1).step(0.0001);
            Gold_FOLDER.add(Gold_MATERIAL, 'roughness').min(0).max(1).step(0.0001); */

            Gold_MESH.material = Gold_MATERIAL;

        // 18 = Steel

            /* let Steel_FOLDER = gui.addFolder('Steel'); */
            ...
            /* Steel_FOLDER.addColor(colors, 'Steel_COLOR')
                .name('color')
                .onChange(function() {
                    Steel_MATERIAL.color.set(colors.Steel_COLOR);
                });
            Steel_FOLDER.add(Steel_MATERIAL, 'metalness').min(0).max(1).step(0.0001);
            Steel_FOLDER.add(Steel_MATERIAL, 'roughness').min(0).max(1).step(0.0001); */

            Steel_MESH.material = Steel_MATERIAL;

        // 19 = Plastic_black

            /* let Plastic_black_FOLDER = gui.addFolder('Plastic_black'); */
            ...
            /* Plastic_black_FOLDER.addColor(colors, 'Plastic_black_COLOR')
                .name('color')
                .onChange(function() {
                    Plastic_black_MATERIAL.color.set(colors.Plastic_black_COLOR);
                });
            Plastic_black_FOLDER.add(Plastic_black_MATERIAL, 'metalness').min(0).max(1).step(0.0001);
            Plastic_black_FOLDER.add(Plastic_black_MATERIAL, 'roughness').min(0).max(1).step(0.0001); */

            Plastic_black_MESH.material = Plastic_black_MATERIAL;

        // 20 = Plastic_white

            /* let Plastic_white_FOLDER = gui.addFolder('Plastic_white'); */
            ...
            /* Plastic_white_FOLDER.addColor(colors, 'Plastic_white_COLOR')
                .name('color')
                .onChange(function() {
                    Plastic_white_MATERIAL.color.set(colors.Plastic_white_COLOR);
                });
            Plastic_white_FOLDER.add(Plastic_white_MATERIAL, 'metalness').min(0).max(1).step(0.0001);
            Plastic_white_FOLDER.add(Plastic_white_MATERIAL, 'roughness').min(0).max(1).step(0.0001); */

            Plastic_white_MESH.material = Plastic_white_MATERIAL;

        // 21 = Plastic_yellow

            /* let Plastic_yellow_FOLDER = gui.addFolder('Plastic_yellow'); */
            ...
            /* Plastic_yellow_FOLDER.addColor(colors, 'Plastic_yellow_COLOR')
                .name('color')
                .onChange(function() {
                    Plastic_yellow_MATERIAL.color.set(colors.Plastic_yellow_COLOR);
                });
            Plastic_yellow_FOLDER.add(Plastic_yellow_MATERIAL, 'metalness').min(0).max(1).step(0.0001);
            Plastic_yellow_FOLDER.add(Plastic_yellow_MATERIAL, 'roughness').min(0).max(1).step(0.0001); */

            Plastic_yellow_MESH.material = Plastic_yellow_MATERIAL;

        // 22 = Luminium

            /* let Luminium_FOLDER = gui.addFolder('Luminium'); */
            ...
            /* Luminium_FOLDER.addColor(colors, 'Luminium_COLOR')
                .name('color')
                .onChange(function() {
                    Luminium_MATERIAL.color.set(colors.Luminium_COLOR);
                });
            Luminium_FOLDER.add(Luminium_MATERIAL, 'metalness').min(0).max(1).step(0.0001);
            Luminium_FOLDER.add(Luminium_MATERIAL, 'roughness').min(0).max(1).step(0.0001); */

            Luminium_MESH.material = Luminium_MATERIAL;

        // 23 = Plastic_black_gloss

            /* let Plastic_black_gloss_FOLDER = gui.addFolder('Plastic_black_gloss'); */
            ...
            /* Plastic_black_gloss_FOLDER.addColor(colors, 'Plastic_black_gloss_COLOR')
                .name('color')
                .onChange(function() {
                    Plastic_black_gloss_MATERIAL.color.set(colors.Plastic_black_gloss_COLOR);
                });
            Plastic_black_gloss_FOLDER.add(Plastic_black_gloss_MATERIAL, 'metalness').min(0).max(1).step(0.0001);
            Plastic_black_gloss_FOLDER.add(Plastic_black_gloss_MATERIAL, 'roughness').min(0).max(1).step(0.0001); */
...
loader.load(
	...
	function (gltf) {
        ...
        Ground_GLTF = gltf.scene;
        console.log(Ground_GLTF);
		gltf.asset;
        gltf.scene.traverse(function(child) {
            console.log(child);
        });
        ...
        ground_MATERIAL.color = new THREE.Color( 0x000000 );
        ground_MATERIAL.alphaMap = ground_ALPHA_TEXTURE;
...
/* loader.load(
	...
	function (gltf) {
        ...
        var Screen_MESH = gltf.scene.getObjectByName("Screen");
        const Screen_MATERIAL = new THREE.MeshStandardMaterial();
        Screen_MATERIAL.color = Screen_VIDEO_TEXTURE;
